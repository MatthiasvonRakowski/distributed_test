...
void runBenchmark()
{
  ...
  // NOTE: for OpenMP measurements DO NOT USE clock()
  //       you should instead use omp_get_wtime()
  //
  // See: https://gitlab-student.macs.hw.ac.uk/f20dp/f20dp-openmp-examples/-/blob/main/omp_get_wtime/omp_get_wtime.c
...
//* gcc-15 -Wall -O2 -fopenmp code_originel.c -o codeOriginel